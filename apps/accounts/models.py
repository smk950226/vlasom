...
class User(AbstractUser):
    ...
    def send_verification_email(self, current_site):
        ...
        email_subject = render_to_string('accounts/registration/verify/user_verify_subject.txt')
        email_content = render_to_string('accounts/registration/verify/user_verify_email.html', context={'url': url, 'site_name': current_site.name})
